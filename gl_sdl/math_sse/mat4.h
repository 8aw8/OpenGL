...
class mat4
{
	...
	public:
		...
		// array float [16]
		inline mat4(float *_m) {
			m1 = _mm_setr_ps( _m[0],  _m[1],  _m[2],  _m[3]);
			m2 = _mm_setr_ps( _m[4],  _m[5],  _m[6],  _m[7]);
			m3 = _mm_setr_ps( _m[8],  _m[9], _m[10], _m[11]);
			m4 = _mm_setr_ps(_m[12], _m[13], _m[14], _m[15]);
		}
